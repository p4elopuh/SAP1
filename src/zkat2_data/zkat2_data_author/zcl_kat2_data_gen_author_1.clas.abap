CLASS zcl_kat2_data_gen_author_1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_KAT2_DATA_GEN_AUTHOR_1 IMPLEMENTATION.
  ...
  METHOD fill_author.
    ...
    DATA: lt_author TYPE TABLE OF zkat2_author.
    ...
    DELETE FROM zkat2_author.
    INSERT zkat2_author FROM TABLE @lt_author.
